...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:[&>*]:translate-y-0.5",
  {
    variants: {
      ...
      size: {
        default: `h-11 text-sm [&>*]:px-4 [&>*]:py-2`,
        small,
        sm: small,
        large,
        lg: large,
...
const Button: React.FCC<ButtonProps> = React.forwardRef<
...
function InnerButtonContainerElement({
  ...
  const className = `flex w-full h-full items-center transition-transform ring-offset-background duration-500 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`;
